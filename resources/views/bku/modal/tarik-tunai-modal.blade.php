        ...
        <div class="modal-content shadow-sm border-0 rounded-4">
            ...
            <div class="modal-body p-4">
                <form>
                    <div class="row g-4">
                        <div class="col-md-6">
                            <label for="tanggalTarik1" class="form-label fw-semibold">Tanggal Tarik Tunai</label>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <label for="tanggalTarik2" class="form-label fw-semibold mb-0">Jumlah Penarikan</label>
