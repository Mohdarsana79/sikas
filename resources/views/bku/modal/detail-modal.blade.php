@if(isset($bku) && $bku)
<div class="modal fade" id="detailModal{{ $bku->id }}" tabindex="-1" aria-hidden="true" data-bku-id="{{ $bku->id }}">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <div class="mb-2">
                            ...
                            {{ $bku->tanggal_lapor ? \Carbon\Carbon::parse($bku->tanggal_lapor)->format('d M Y') : '-'
                            }}
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <!-- Tabel Detail Uraian -->
                @if($bku->uraianDetails && count($bku->uraianDetails) > 0)
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tfoot class="table-group-divider">
                            ...
                            <tr>
                                <th colspan="3" class="text-end">Pajak ({{ $bku->pajak ?? 'Pajak' }}):</th>
                                <th class="text-end">Rp {{ number_format($bku->total_pajak, 0, ',', '.') }}</th>
                            </tr>
                            @endif
                            @if($bku->total_pajak_daerah > 0)
                            <tr>
                                <th colspan="3" class="text-end">Pajak Daerah ({{ $bku->pajak_daerah ?? 'Pajak Daerah'
                                    }}):</th>
                ...
                <div class="alert alert-info">
                    ...
                    Tidak ada detail uraian untuk transaksi ini.
                </div>
                @endif
            </div>
