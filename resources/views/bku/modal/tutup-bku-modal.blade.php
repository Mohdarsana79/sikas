        ...
        <div class="modal-content shadow-sm border-0 rounded-4">
            ...
            <div class="modal-body p-4">
                <form>
                    <div class="row g-4">
                        <div class="col-md-12">
                            <label for="jasaGiro" class="form-label fw-semibold">Bunga Bank / Jasa Giro</label>
                            <div class="input-group input-group-sm">
                                <span class="input-group-text bg-light text-primary">
                                    <i class="bi bi-currency-dollar"></i>
                                </span>
                                <input type="text" class="form-control" id="jasaGiro" placeholder="Rp. 0"
                                    aria-describedby="jasaGiroHelp" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <label for="pajakBunga" class="form-label fw-semibold">Pajak Bunga Bank / Administrasi</label>
                            <div class="input-group input-group-sm">
                                <span class="input-group-text bg-light text-primary">
                                    <i class="bi bi-currency-dollar"></i>
                                </span>
                                <input type="text" class="form-control" id="pajakBunga" placeholder="Rp. 0"
