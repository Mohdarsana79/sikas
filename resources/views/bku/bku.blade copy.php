                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="fw-semibold">
                                ...
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text" id="inputGroup-sizing-sm">Rp</span>
                                    <input type="text" class="form-control" value="{{ number_format($anggaranBelumDibelanjakan, 0, ',', '.') }}" aria-label="Sizing example input"
...
@include('bku.modal.edit-bunga-bank-modal')
