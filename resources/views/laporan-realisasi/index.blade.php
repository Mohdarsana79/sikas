                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-8">
                                ...
                                <h1 class="banner-title">
                                    <span class="title-main">LAPORAN REALISASI</span>
                                </h1>
                                <p class="banner-description">
                                    Modul Laporan Realisasi sedang dalam tahap pengembangan aktif. Kami membangun solusi terbaik
                    ...
                    <div class="cta-card bg-gradient-primary text-white text-center">
                        <div class="cta-content">
                            ...
                            <p class="cta-description">
                                Kami akan memberitahu Anda ketika Laporan Realisasi siap diluncurkan.
