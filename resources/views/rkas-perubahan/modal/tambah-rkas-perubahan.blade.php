...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function formatRupiah(angka) {
            // Jika sudah berupa string dengan format, konversi dulu ke number
        ...
        function createAnggaranCard() {
            ...
            // Event listener untuk klik card (selected state)
        ...
        function handleTambahBulanClick() {
            ...
            // Beri sedikit delay untuk update total
        ...
        if (hargaSatuanInput) {
            ...
            hargaSatuanInput.addEventListener('input', function(e) {
                ...
                // Update total anggaran dengan delay
                setTimeout(updateTotalAnggaran, 50);
            });
