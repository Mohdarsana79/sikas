            ...
            <div class="modal-body">
                ...
                <div class="anggaran-box">
                    <div class="anggaran-info text-white">
                        <span class="text-white"><i class="bi bi-calendar-month me-2"></i>Di Anggarkan untuk
                            bulan</span>
                        <span class="text-white">Total Anggaran : <span class="text-white"
                                id="detail_total_anggaran_display">Rp. 0</span></span>
                    </div>
