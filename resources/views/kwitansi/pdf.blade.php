        ...
        <div class="tax-and-total">
            <div class="tax-section">
                ...
                <div class="tax-item">
                    <span>PPn</span>
                    <span>=</span>
                    <span style="width: 200px; text-align: left; padding-left: 5px;">Rp {{
                        number_format($pajakData['ppn'] ?? 0, 0, ',', '.') }}</span>
                </div>
                <div class="tax-item">
                    <span>PPh</span>
                    <span>=</span>
                    <span style="width: 200px; text-align: left; padding-left: 5px;">Rp {{
                        number_format($pajakData['pph'] ?? 0, 0, ',', '.') }}</span>
                </div>
                <div class="tax-item">
                    <span>PB 1</span>
                    <span>=</span>
                    <span style="width: 200px; text-align: left; padding-left: 5px;">Rp {{
                        number_format($pajakData['pb1'] ?? 0, 0, ',', '.') }}</span>
                </div>
